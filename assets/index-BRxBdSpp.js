...
md:text-4xl\r
        ...
        `,children:[(0,F.jsx)(`div`,{className:`\r
          ...
          `,children:(0,F.jsx)(Li,{className:`w-6 h-6 text-white`})}),(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`h3`,{className:`\r
            ...
            `,children:`Reliable Long-Term Support`}),(0,F.jsx)(`p`,{className:`\r
              ...
              leading-relaxed\r
              text-[15px]\r
            `,children:`Our dedicated support ensures businesses receive continuous assistance and enterprise-grade reliability.`})]})]})]})]})]})]})}function $v(){return(0,F.jsxs)(F.Fragment,{children:[(0,F.jsxs)(`section`,{className:`\r
    relative\r
    overflow-hidden\r
    pt-24\r
    sm:pt-28\r
  ...
  `,children:[(0,F.jsx)(`div`,{className:`\r
            ...
            blur-3xl\r
            rounded-full\r
          `}),(0,F.jsx)(`div`,{className:`max-w-6xl mx-auto px-4 sm:px-6 relative z-10`,children:(0,F.jsxs)(`div`,{className:`text-center max-w-4xl mx-auto`,children:[(0,F.jsx)(`p`,{className:`\r
                inline-flex\r
                items-center\r
                gap-2\r
                px-4\r
              ...
              `,children:`Enterprise Tally Solutions`}),(0,F.jsxs)(`h1`,{className:`\r
                ...
                text-[#071426]\r
                mb-8\r
              `,children:[`Powerful Products`,(0,F.jsx)(`br`,{}),(0,F.jsx)(`span`,{className:`text-[#2563EB]`,children:`Built For Growth`})]}),(0,F.jsx)(`p`,{className:`\r
                text-[15px]\r
                sm:text-lg\r
                md:text-xl\r
                text-slate-600\r
                ...
                sm:max-w-3xl\r
                mx-auto\r
              `,children:`Explore intelligent Tally solutions designed for accounting, automation, cloud infrastructure, business management, and enterprise productivity.`})]})})]}),(0,F.jsxs)(`section`,{className:`\r
          relative\r
          py-14\r
          sm:py-16\r
          md:py-20\r
            ...
            `,children:[{title:`TallyPrime`,desc:`Complete business accounting and GST management software.`,image:Gv,features:[`GST Billing`,`Inventory Management`,`Financial Reports`],route:`/products/tallyprime`},{title:`TallyPrime Server`,desc:`Enterprise-grade data security and multi-user performance.`,image:Kv,features:[`Centralized Data`,`High Performance`,`Data Reliability`],route:`/products/tally-server`},{title:`TallyPrime powered by AWS`,desc:`Secure cloud-based Tally access from anywhere.`,image:qv,features:[`Cloud Access`,`Remote Work`,`AWS Security`],route:`/products/aws`},{title:`TallyPrime with WhatsApp`,desc:`Automate customer communication and invoice sharing.`,image:Jv,features:[`Invoice Sharing`,`Auto Notifications`,`Customer Engagement`],route:`/products/whatsapp`}].map((e,t)=>(0,F.jsxs)(Mn,{to:e.route,className:`\r
                ...
                `,children:[(0,F.jsxs)(`div`,{className:`relative overflow-hidden h-[180px] sm:h-[200px]`,children:[(0,F.jsx)(`img`,{src:e.image,alt:e.title,className:`\r
                    ...
                    `,children:e.desc}),(0,F.jsx)(`div`,{className:`space-y-3 mb-6`,children:e.features.map((e,t)=>(0,F.jsxs)(`div`,{className:`\r
                      ...
                      group-hover:gap-4\r
                      transition-all duration-300\r
                    `,children:[`Explore Product`,(0,F.jsx)(cr,{size:18})]})]})]},t))})]})]})]})}function ey({plan:e,index:t}){let n=e.variants?.length>0,[r,i]=(0,w.useState)(e.variants?.[0]||null);return(0,w.useEffect)(()=>{i(e.variants?.[0]||null)},[e]),(0,F.jsxs)(`div`,{className:`
...
md:text-[44px] font-bold leading-tight text-[#0B132B]`,children:[`Why Businesses Choose`,` `,(0,F.jsx)(`span`,{className:`bg-gradient-to-r from-[#1E73E8] to-[#4F8CFF] bg-clip-text text-transparent`,children:`TallyPrime Server`})]}),(0,F.jsx)(`p`,{className:`mt-6 text-lg md:text-xl text-[#5B6475] leading-relaxed`,children:`Built for growing businesses that need speed, security, multi-user efficiency, and uninterrupted access to critical data.`})]}),(0,F.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6`,children:t.whyChooseCards.map((e,t)=>{let n=e.icon;return(0,F.jsxs)(`div`,{className:`\r
  ...
  `,children:(0,F.jsx)(`div`,{className:`relative z-10 max-w-7xl mx-auto w-full py-6 sm:py-8 md:py-10`,children:(0,F.jsxs)(`div`,{className:`\r
      ...
      gap-6\r
      sm:gap-8\r
    `,children:ry.map((e,t)=>{let n=e.icon;return(0,F.jsxs)(Mn,{to:e.path,className:`\r
              group relative overflow-hidden\r
              rounded-[22px]\r
              sm:rounded-[28px]\r
...
lg:text-xl\r
  ...
  `,children:[(0,F.jsx)(`h2`,{className:`\r
    ...
    `,children:`What You'll Learn`}),(0,F.jsx)(`div`,{className:`space-y-6 lg:space-y-10`,children:(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`p`,{className:`\r
        ...
        `,children:t.sections.find(e=>e.id===`overview`)?.content}),(0,F.jsx)(`div`,{className:`space-y-5`,children:t.sections.find(e=>e.id===`overview`)?.learn.map((e,t)=>(0,F.jsxs)(`div`,{className:`\r
              ...
              `,children:[(0,F.jsxs)(`div`,{className:`\r
                    ...
                    font-medium\r
                    shrink-0\r
                  `,children:[(0,F.jsx)(hy[e.icon]||fr,{className:`w-4 h-4`}),e.title]}),(0,F.jsx)(`p`,{className:`\r
                    text-slate-700\r
                    leading-7\r
    ...
    gap-4\r
    md:gap-6\r
  `,children:e.groups?.map((e,t)=>{let n=gy[e.title];return(0,F.jsxs)(`div`,{className:`\r
  bg-white\r
  border\r
  border-slate-200\r
  rounded-xl\r
...
lg:py-6\r
    ...
    duration-300\r
    group\r
  `,children:[(0,F.jsxs)(`div`,{className:`flex items-start gap-3 min-w-0`,children:[(()=>{let t=_y[e.type];return(0,F.jsx)(`div`,{className:`\r
            mt-1\r
            text-[#2563EB]\r
            group-hover:translate-x-1\r
            transition-transform\r
...
`),t=new Blob([e],{type:`text/csv`}),n=window.URL.createObjectURL(t),i=document.createElement(`a`);i.href=n,i.download=`opening-balance-dataset.csv`,i.click()},className:`\r
  ...
  `,children:c?(0,F.jsxs)(`div`,{className:`text-center`,children:[(0,F.jsx)(`div`,{className:`\r
      ...
      `,children:[(0,F.jsx)(`h3`,{className:`font-semibold mb-5`,children:`Lab Checklist`}),(0,F.jsxs)(`div`,{className:`space-y-4`,children:[r.steps.map(e=>(0,F.jsxs)(`button`,{onClick:()=>h(e.title),className:`\r
        ...
        rounded-3xl\r
        p-6\r
      `,children:[(0,F.jsx)(`h3`,{className:`font-semibold mb-5`,children:`Quick Navigation`}),(0,F.jsx)(`div`,{className:`space-y-3`,children:by.map(e=>(0,F.jsx)(`a`,{href:`#${e.id}`,className:`\r
            block\r
            text-sm\r
            text-slate-600\r
  ...
  mt-4 sm:mt-5\r
      ...
      order-1 lg:order-2`,initial:{opacity:0,x:100},whileInView:{opacity:1,x:0},transition:{duration:1,ease:`easeOut`,delay:`0.2`},viewport:{once:!0},children:(0,F.jsxs)(`div`,{className:`relative`,children:[(0,F.jsxs)(`div`,{className:`\r
        ...
        `,children:[(0,F.jsx)(`img`,{src:Cy,alt:`Contact Balaji Infotech`,className:`\r
              w-full\r
              h-[320px]\r
              sm:h-[320px]\r
              lg:h-[420px]\r
...
\r
            ...
            `,children:e.title}),(0,F.jsx)(`p`,{className:`\r
              ...
              leading-[1.8]\r
              text-[#64748B]\r
            `,children:e.description})]},t)})})]})})]})}function Ey(){return(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(Zn,{}),(0,F.jsxs)(`div`,{className:`overflow-x-hidden`,children:[(0,F.jsx)(ta,{}),(0,F.jsxs)(Vt,{children:[(0,F.jsx)(zt,{path:`/`,element:(0,F.jsx)(Yv,{})}),(0,F.jsx)(zt,{path:`/about`,element:(0,F.jsx)(Qv,{})}),(0,F.jsx)(zt,{path:`/products`,element:(0,F.jsx)($v,{})}),(0,F.jsx)(zt,{path:`/products/:slug`,element:(0,F.jsx)(ny,{})}),(0,F.jsx)(zt,{path:`/services`,element:(0,F.jsx)(ay,{})}),(0,F.jsx)(zt,{path:`/services/:slug`,element:(0,F.jsx)(oy,{})}),(0,F.jsx)(zt,{path:`/education`,element:(0,F.jsx)(Ty,{})}),(0,F.jsx)(zt,{path:`/lms`,element:(0,F.jsx)(py,{})}),(0,F.jsx)(zt,{path:`/courses/:slug`,element:(0,F.jsx)(yy,{})}),(0,F.jsx)(zt,{path:`/lms/:exerciseSlug`,element:(0,F.jsx)(Sy,{})}),(0,F.jsx)(zt,{path:`/contact`,element:(0,F.jsx)(wy,{})})]}),(0,F.jsx)(ya,{})]})]})}Xn.createRoot(document.getElementById(`root`)).render((0,F.jsx)(kn,{basename:`/Balaji-Infotech`,children:(0,F.jsx)(Ey,{})}));