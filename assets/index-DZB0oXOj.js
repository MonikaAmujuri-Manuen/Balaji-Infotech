...
\r
                shadow-[0_20px_60px_rgba(0,0,0,0.08)]\r
              `,children:[(0,P.jsx)(`img`,{src:`/images/about.png`,alt:`About Balaji AI Infotech`,className:`\r
                  w-full\r
                  h-full\r
                  object-cover\r
                `}),(0,P.jsx)(`div`,{className:`\r
...
\r
      ...
      `,children:[(0,P.jsxs)(`div`,{className:`absolute inset-0 overflow-hidden`,children:[(0,P.jsx)(`div`,{className:`\r
        ...
        `,children:[(0,P.jsxs)($.div,{initial:{opacity:0,y:40},whileInView:{opacity:1,y:0},transition:{duration:.8},viewport:{once:!0},children:[(0,P.jsxs)(`div`,{className:`\r
            ...
            `}),(0,P.jsxs)(`div`,{className:`relative mt-4 lg:mt-0\r
              ...
              bg-white\r
            `,children:[(0,P.jsx)(`img`,{src:Nv,alt:`About Balaji Infotech`,className:`\r
                w-full\r
                h-[320px]\r
                sm:h-[420px]\r
                lg:h-[520px]\r
  ...
  `,children:[(0,P.jsxs)(`div`,{className:`\r
    ...
    text-transparent\r
    mb-4\r
  `,children:(0,P.jsx)(Pv,{end:24,suffix:`+`})}),(0,P.jsx)(`p`,{className:`\r
        text-lg\r
        md:text-xl\r
        font-semibold\r
        text-[#0B1220]\r
    ...
    text-transparent\r
    mb-4\r
  `,children:(0,P.jsx)(Pv,{end:100,suffix:`%`})}),(0,P.jsx)(`p`,{className:`\r
        text-lg\r
        md:text-xl\r
        font-semibold\r
        text-[#0B1220]\r
    ...
    text-transparent\r
    mb-4\r
  `,children:(0,P.jsx)(Pv,{end:1e3,suffix:`+`})}),(0,P.jsx)(`p`,{className:`\r
        text-lg\r
        md:text-xl\r
        font-semibold\r
        text-[#0B1220]\r
      ...
      `,children:[(0,P.jsxs)($.div,{whileHover:{y:-6},transition:{duration:.3},className:`\r
        ...
        `,children:[(0,P.jsx)(`div`,{className:`\r
          ...
          `,children:(0,P.jsx)(Ci,{className:`w-6 h-6 text-white`})}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{className:`\r
            ...
            `,children:`Reliable Long-Term Support`}),(0,P.jsx)(`p`,{className:`\r
              ...
              leading-relaxed\r
              text-[15px]\r
            `,children:`Our dedicated support ensures businesses receive continuous assistance and enterprise-grade reliability.`})]})]})]})]})]})]})}function Iv(){return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(`section`,{className:`\r
          relative\r
          overflow-hidden\r
          pt-28\r
          sm:pt-32\r
        ...
        `,children:[(0,P.jsx)(`div`,{className:`\r
          ...
          `}),(0,P.jsxs)(`div`,{className:`max-w-5xl mx-auto px-4 sm:px-6 relative z-10`,children:[(0,P.jsxs)(`div`,{className:`text-center mb-16`,children:[(0,P.jsx)(`p`,{className:`\r
              ...
              gap-6\r
              sm:gap-8\r
            `,children:[{title:`TallyPrime`,desc:`Complete business accounting and GST management software.`,image:Ov,features:[`GST Billing`,`Inventory Management`,`Financial Reports`],route:`/products/tallyprime`},{title:`TallyPrime Server`,desc:`Enterprise-grade data security and multi-user performance.`,image:kv,features:[`Centralized Data`,`High Performance`,`Data Reliability`],route:`/products/tally-server`},{title:`TallyPrime powered by AWS`,desc:`Secure cloud-based Tally access from anywhere.`,image:Av,features:[`Cloud Access`,`Remote Work`,`AWS Security`],route:`/products/aws`},{title:`TallyPrime with WhatsApp`,desc:`Automate customer communication and invoice sharing.`,image:jv,features:[`Invoice Sharing`,`Auto Notifications`,`Customer Engagement`],route:`/products/whatsapp`}].map((e,t)=>(0,P.jsxs)(Mn,{to:e.route,className:`\r
                  group\r
                  relative\r
                  rounded-[20px]\r
                  sm:rounded-[24px]\r
                ...
                `,children:[(0,P.jsxs)(`div`,{className:`relative overflow-hidden h-[180px] sm:h-[200px]`,children:[(0,P.jsx)(`img`,{src:e.image,alt:e.title,className:`\r
                    ...
                    `,children:e.desc}),(0,P.jsx)(`div`,{className:`space-y-3 mb-6`,children:e.features.map((e,t)=>(0,P.jsxs)(`div`,{className:`\r
                      ...
                      group-hover:gap-4\r
                      transition-all duration-300\r
                    `,children:[`Explore Product`,(0,P.jsx)(or,{size:18})]})]})]},t))})]})]})]})}function Lv({plan:e,index:t}){let n=e.variants?.length>0,[r,i]=(0,w.useState)(e.variants?.[0]||null);return(0,w.useEffect)(()=>{i(e.variants?.[0]||null)},[e]),(0,P.jsxs)(`div`,{className:`
  ...
  `}),(0,P.jsxs)(`div`,{className:`relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center`,children:[(0,P.jsx)(`div`,{className:`\r
    ...
    `})]}),(0,P.jsxs)(`div`,{className:`relative z-10 max-w-6xl mx-auto px-4 sm:px-6`,children:[(0,P.jsxs)(`div`,{className:`text-center max-w-3xl mx-auto mb-20`,children:[(0,P.jsxs)(`div`,{className:`\r
      ...
      gap-6\r
      sm:gap-8\r
    `,children:Bv.map((e,t)=>{let n=e.icon;return(0,P.jsxs)(Mn,{to:e.path,className:`\r
              group relative overflow-hidden\r
              rounded-[22px]\r
              sm:rounded-[28px]\r
...
\r
        ...
        hover:scale-110\r
        transition-all duration-300\r
      `,children:(0,P.jsx)(ui,{className:`w-6 h-6 sm:w-7 sm:h-7`})})]})},Wv=`/Balaji-Infotech/assets/lmshero-Bd9EAadC.png`,Gv=`/Balaji-Infotech/assets/basics-ChOuIBMf.png`,Kv=`/Balaji-Infotech/assets/gst-CwR4GFuj.png`,qv=`/Balaji-Infotech/assets/inventory-DQLd9vdY.png`,Jv=`/Balaji-Infotech/assets/payroll-lGy70-lh.jpg`,Yv=`/Balaji-Infotech/assets/reports-BuKQqLAM.jpg`,Xv=`/Balaji-Infotech/assets/advanced-DodPshiB.jpg`;function Zv(){let e=[{step:`01`,level:`Beginner`,title:`Basics & Ledgers`,description:`Learn company creation, ledgers, voucher entries, journals, and accounting fundamentals.`,time:`3–4 Hours`,image:Gv},{step:`02`,level:`Intermediate`,title:`GST & Taxation`,description:`Master GST configuration, invoices, returns, debit notes, and compliance workflows.`,time:`6–8 Hours`,image:Kv},{step:`03`,level:`Intermediate`,title:`Inventory & Stock`,description:`Understand stock items, godowns, batching, reorder levels, and manufacturing basics.`,time:`4–6 Hours`,image:qv},{step:`04`,level:`Advanced`,title:`Payroll Management`,description:`Learn employee setup, salary structures, PF/ESI deductions, and payroll processing.`,time:`5–7 Hours`,image:Jv},{step:`05`,level:`Advanced`,title:`Reports & MIS`,description:`Generate profit & loss reports, balance sheets, ratio analysis, and MIS dashboards.`,time:`4–5 Hours`,image:Yv},{step:`06`,level:`Expert`,title:`Advanced TallyPrime`,description:`Security controls, multi-company workflows, backup & restore, and advanced customization.`,time:`6–9 Hours`,image:Xv}],t=[{title:`GST Invoice Challenge`,description:`Create GST invoices, configure taxes, and manage debit/credit notes.`,time:`25 Minutes`,level:`Intermediate`},{title:`Payroll Workflow Setup`,description:`Configure employee salary structures and process payroll entries.`,time:`40 Minutes`,level:`Advanced`},{title:`Inventory Stock Transfer`,description:`Practice godown transfers, batching, and stock management workflows.`,time:`30 Minutes`,level:`Intermediate`}],n=[{title:`GST Cheat Sheet`,description:`Quick GST rates, shortcuts, filing process, and invoice formats.`,type:`PDF FILE`,icon:(0,P.jsx)(Nr,{className:`w-7 h-7`})},{title:`Sample Company Data`,description:`Practice with real-world TallyPrime business datasets and ledgers.`,type:`ZIP FILE`,icon:(0,P.jsx)(Tr,{className:`w-7 h-7`})},{title:`Payroll Templates`,description:`Ready-to-use employee salary structure and payroll templates.`,type:`XLS FILE`,icon:(0,P.jsx)(Mr,{className:`w-7 h-7`})},{title:`TallyPrime Notes`,description:`Detailed learning notes covering accounting, GST, and inventory.`,type:`DOC FILE`,icon:(0,P.jsx)(kr,{className:`w-7 h-7`})}];return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(`section`,{className:`relative overflow-x-hidden pt-32 sm:pt-28 lg:pt-32 pb-14 sm:pb-20`,children:[(0,P.jsxs)(`div`,{className:`absolute inset-0`,children:[(0,P.jsx)(`img`,{src:Wv,alt:`LMS Hero`,className:`w-full h-full object-cover`}),(0,P.jsx)(`div`,{className:`absolute inset-0 bg-[#020817]/70`}),(0,P.jsx)(`div`,{className:`\r
      absolute inset-0\r
      bg-gradient-to-r\r
      from-[#020817]/80\r
      via-[#020817]/50\r
    ...
    `,children:[(0,P.jsxs)(`div`,{className:`\r
      ...
      `,children:`Everything you need to know about the LMS, learning roadmap, exercises, downloads, and certification support.`})]}),(0,P.jsx)(`div`,{className:`mt-16 space-y-5`,children:[{question:`Do I need accounting knowledge before starting?`,answer:`No. The LMS roadmap starts from absolute basics including company creation, ledgers, vouchers, and accounting workflows.`},{question:`Will I get practice exercises and sample company data?`,answer:`Yes. Every major module includes practical exercises, downloadable datasets, GST templates, and workflow simulations.`},{question:`Can I learn GST, payroll, and inventory together?`,answer:`Absolutely. The roadmap is designed as a complete business accounting workflow covering GST, payroll, banking, inventory, and reports.`},{question:`Is this suitable for job preparation?`,answer:`Yes. The LMS includes real-world accounting scenarios, hands-on labs, invoice exercises, and business reporting workflows used in companies.`},{question:`Do you provide certification guidance?`,answer:`Yes. We help learners prepare for Tally certifications and provide guidance for practical business accounting implementation.`}].map((e,t)=>(0,P.jsxs)(`details`,{className:`\r
          ...
          `,children:(0,P.jsx)(`p`,{className:`\r
              ...
              md:text-[17px]\r
              max-w-4xl\r
            `,children:e.answer})})]},t))})]})})]})}var Qv=`/Balaji-Infotech/assets/contact-hero-Dk74wo4A.png`;function $v(){let e=ut();return(0,w.useEffect)(()=>{if(e.hash){let t=document.querySelector(e.hash);t&&t.scrollIntoView({behavior:`smooth`})}},[e]),(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(`section`,{className:`\r
    relative\r
    overflow-hidden\r
  ...
  `,children:[(0,P.jsx)(`div`,{className:`\r
    ...
    `,children:[(0,P.jsxs)($.div,{initial:{opacity:0,x:-80},whileInView:{opacity:1,x:0},transition:{duration:.8,ease:`easeOut`},viewport:{once:!0},children:[(0,P.jsxs)(`div`,{className:`\r
      ...
      order-1 lg:order-2`,initial:{opacity:0,x:100},whileInView:{opacity:1,x:0},transition:{duration:1,ease:`easeOut`,delay:`0.2`},viewport:{once:!0},children:(0,P.jsxs)(`div`,{className:`relative`,children:[(0,P.jsxs)(`div`,{className:`\r
        ...
        `,children:[(0,P.jsx)(`img`,{src:Qv,alt:`Contact Balaji Infotech`,className:`\r
              w-full\r
              h-[420px]\r
              sm:h-[520px]\r
              lg:h-[620px]\r
...
\r
            ...
            `,children:e.title}),(0,P.jsx)(`p`,{className:`\r
              ...
              leading-[1.8]\r
              text-[#64748B]\r
            `,children:e.description})]},t)})})]})]})]})}function ty(){return(0,P.jsx)(P.Fragment,{children:(0,P.jsxs)(`div`,{className:`overflow-x-hidden`,children:[(0,P.jsx)(Bi,{}),(0,P.jsxs)(Vt,{children:[(0,P.jsx)(zt,{path:`/`,element:(0,P.jsx)(Mv,{})}),(0,P.jsx)(zt,{path:`/about`,element:(0,P.jsx)(Fv,{})}),(0,P.jsx)(zt,{path:`/products`,element:(0,P.jsx)(Iv,{})}),(0,P.jsx)(zt,{path:`/products/:slug`,element:(0,P.jsx)(zv,{})}),(0,P.jsx)(zt,{path:`/services`,element:(0,P.jsx)(Hv,{})}),(0,P.jsx)(zt,{path:`/services/:slug`,element:(0,P.jsx)(Uv,{})}),(0,P.jsx)(zt,{path:`/education`,element:(0,P.jsx)(ey,{})}),(0,P.jsx)(zt,{path:`/lms`,element:(0,P.jsx)(Zv,{})}),(0,P.jsx)(zt,{path:`/contact`,element:(0,P.jsx)($v,{})})]}),(0,P.jsx)(aa,{})]})})}N.createRoot(document.getElementById(`root`)).render((0,P.jsx)(kn,{basename:`/Balaji-Infotech`,children:(0,P.jsx)(ty,{})}));